...
import {
  DollarSign, Users, TrendingUp, FolderKanban, Search,
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                <p className="text-xs sm:text-sm text-muted-foreground truncate">Fonds Décaissés</p>
                <p className="text-xl sm:text-2xl font-bold">
                  {(stats.totalDisbursed / 1000000).toFixed(0)}M
                </p>
          ...
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                ...
                <p className="text-xl sm:text-2xl font-bold">{stats.projectsFunded}</p>
              </div>
        ...
        <Card className="hover:shadow-lg transition-shadow">
          <CardContent className="p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="min-w-0">
                <p className="text-xs sm:text-sm text-muted-foreground truncate">Impact Score</p>
        ...
        <TabsContent value="portfolio" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Suivez la performance de votre portefeuille de projets</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
                <FolderKanban className="h-12 w-12 mx-auto mb-4 opacity-50" />
                <p>Vos projets financés apparaîtront ici</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="pipeline">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Projets en cours d'évaluation pour financement</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-8 text-muted-foreground">
        ...
        <TabsContent value="impact">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Mesurez l'impact social et économique de vos financements</CardDescription>
            </CardHeader>
            <CardContent>
